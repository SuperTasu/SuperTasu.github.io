document.addEventListener('DOMContentLoaded', () => {
    ...
    const nekotutiContainer = document.getElementById('nekotuti-container');
    ...
    if (fyEditBtn) {
        fyEditBtn.addEventListener('click', toggleEditMode);
    }
    ...
    window.activateTab = function(tabName) {
        ...
        if(nekotutiContainer) nekotutiContainer.style.display = 'none';
        ...
        if (tabName === 'all-apps') {
            ...
            const btn = document.getElementById('tab-all-apps');
            ...
            const btn = document.getElementById('tab-bustarain');
            if(btn) btn.classList.add('active');
        } else if (tabName === 'option') {
            optionContainer.style.display = 'block';
            const btn = document.getElementById('tab-option');
            if(btn) btn.classList.add('active');
        } else if (tabName === 'fy') {
            fyContainer.style.display = 'block';
            const btn = document.getElementById('tab-fy');
            if(btn) btn.classList.add('active');
            renderFavoritesPage();
        } else if (tabName === 'nekotuti') {
            if(nekotutiContainer) nekotutiContainer.style.display = 'block';
            const btn = document.getElementById('tab-nekotuti');
            if(btn) btn.classList.add('active');
        }
    };
    ...
    // Option/main.js等がこれらの関数を呼べるようにwindowに紐付け（必要であれば）
